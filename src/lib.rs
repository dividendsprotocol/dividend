...
declare_id!("FZ7rgdWAfFDHZKV4NYRkxDgZiXUPe5rEqZ3vCk5VKu6Z");
...
fn calculate_reward(
    ...
    if vault_amount == 0 || start_pool == 0 || base_minutes == 0 {
        return None;
    }

    let held_minutes = time_elapsed_ms / 60_000;
    if held_minutes < base_minutes {
        return Some(0);
    }
    ...
    let periods = held_minutes / base_minutes;
...
pub mod corn_vault {
    ...
    pub fn create_corn_vault(
        ...
        vault.base_minutes = base_minutes;
